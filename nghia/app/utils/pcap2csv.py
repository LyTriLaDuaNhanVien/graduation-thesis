...
def pcap2csv(in_pcap, out_csv):
    ...
    for (pkt_scapy, _) in RawPcapReader(in_pcap):
            ...
            try:
                ...
                result = render_csv_row(pkt_pyshark, pkt_scapy)
                if result is None:
                    ignored_packets += 1
                else:
                    print(result)
    ...
    # with open(out_csv, 'w') as fh_csv:
        ...
        #     break
            ...
            #     result = render_csv_row(pkt_pyshark, pkt_scapy, fh_csv)
            #     if result is None:
            #         ignored_packets += 1
            #     else:
            #         print(result)
...
pcap2csv("DATA/cicddos2019/sample_pcap/CIC-DDoS-2019-Benign.pcap","test.csv")